...
public class Task2 {
	public static void main(String [] args)
	{
		...
		driver.findElement(By.xpath("//*[@id=\"first_name\"]")).sendKeys("Sri dharani");
		driver.findElement(By.xpath("//*[@id=\"last_name\"]")).sendKeys("S");
		driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("sridharani@gmail.com");
		...
		driver.findElement(By.xpath("//*[@id=\"phone_1665627865\"]")).sendKeys("9087564539");
		driver.findElement(By.xpath("//*[@id=\"date_box_1665629845_field\"]/span/input[1]")).sendKeys("15.03.23");
